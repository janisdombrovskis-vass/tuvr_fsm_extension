		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Extension",
									"targetURL": "#tuvrfsmextension-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tuvrfsmextension-display": {
								"semanticObject": "tuvrfsmextension",
								"action": "display",
								"description": "TUVR FSM Extension",
								"title": "Extension",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tuvrfsmextension",
									"url": sap.ui.require.toUrl("tuvrfsmextension")
								}
							}
						}
					}
